    ...
    <div className="container mx-auto p-12">
      <ul className="grid grid-cols-4 gap-4">
        {data.data?.map((product) => (
          ...
          >
            <img
              src={product.attributes.productphoto} // assuming productphoto attribute contains image URL
              alt={product.attributes.name} // assuming name attribute contains product name
